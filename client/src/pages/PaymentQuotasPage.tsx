...
import { UserIcon, SucursalVirtualBanner } from "@/lib/images";
        ...
        <div className="max-w-5xl mx-auto pt-4 px-4">
          ...
          <div className="flex items-center mb-6">
            <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center mr-3">
              <img src={`data:image/png;base64,${UserIcon}`} alt="Usuario" className="w-6 h-6" />
            </div>
            <div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/3">
              ...
              <div className="mt-8 bg-white rounded-lg p-4 border border-blue-100">
                <div>
                  <img src={`data:image/svg+xml;base64,${SucursalVirtualBanner}`} alt="Sucursal Virtual" className="w-full h-auto rounded-lg object-cover mb-3" />
